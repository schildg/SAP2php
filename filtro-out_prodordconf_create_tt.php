...
$smarty->assign("titulo", "Filtro de los datos del out_prodordconf_create_tt");
...
$aOut_ProdOrdConf_Create_TTs = $out_prodordconf_create_tt->FindAll($OBJETO,$QUERY_FILTRO,$ORDEN);
